...
$open_now = "<strong class='open'>Ja, wir haben geöffnet! Die heutigen Öffnungszeiten sind %open% bis %closed%.</strong>";
$closed_now = "<strong class='closed'>Wir haben leider geschlossen. Die heutigen Öffnungszeiten sind von %open% bis %closed%.</strong>";
$closed_all_day = "<strong class='closed'>Wir haben %day% leider geschlossen.</strong>";
$exception = "<strong class='closed'>Wir haben leider wegen %exception% geschlossen.</strong>";
